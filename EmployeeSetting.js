...
const EmployeeSetting = () => {
  ...
  const handleTouchEnd = () => {
    ...
    if (isSwipeLeft) {
      ...
      // Logic for swiping left (e.g., navigate to the next section)
    }

    if (isSwipeRight) {
      console.log('Swiped right');
      // Logic for swiping right (e.g., navigate to the previous section)
    }
  ...
  return (
    <div className="settings-box" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
